...
import type { SynthParameters, GranularTexture } from "@shared/schema";
    ...
    <div className="space-y-1.5">
      ...
      <div className="grid grid-cols-4 gap-0.5">
        {(['mode1', 'mode2', 'mode3', 'mode4'] as const).map((modeKey, i) => {
          ...
          return (
            <div key={modeKey} className="flex flex-col items-center gap-0.5 p-0.5 rounded bg-muted/30">
  ...
  return (
    <div className="space-y-1.5">
      <div className="flex justify-center gap-1">
        ...
        <Knob value={additive.spread} min={0} max={100} step={1} label="Spr" unit="%" onChange={(v) => onChange({ ...additive, spread: v })} size="xs" data-testid="knob-additive-spread" />
      ...
      <div className="grid grid-cols-8 gap-0.5">
        {(['p1', 'p2', 'p3', 'p4', 'p5', 'p6', 'p7', 'p8'] as const).map((pKey, i) => {
          ...
          return (
            <div key={pKey} className="flex flex-col items-center gap-0.5">
