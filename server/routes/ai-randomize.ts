...
{
  "oscillators": {
    "osc1": { "enabled": true/false, "waveform": "sine"|"triangle"|"sawtooth"|"square"|"noise", "pitchHz": 20-20000, "detune": -100 to 100, "drift": 0-100, "level": 0-100, "fmEnabled": true/false, "fmRatio": 0.25-16, "fmDepth": 0-1000, "fmWaveform": same, "fmFeedback": 0-1, "pmEnabled": true/false, "pmRatio": 0.25-16, "pmDepth": 0-60, "pmWaveform": same, "pmFeedback": 0-1, "indexEnvEnabled": true/false, "indexEnvDecay": 2-100, "indexEnvDepth": 0-60 },
    "osc2": { same structure },
    "osc3": { same structure }
  },
  "envelopes": {
  ...
  "spectralScrambler": { "enabled": true/false, "fftSize": "256"|"512"|"1024"|"2048", "scrambleAmount": 0-100, "binShift": -50 to 50, "freeze": false, "mix": 0-100 },
